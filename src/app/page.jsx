...
export default function Home() {
      ...
      <div className="bg-white py-8 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-sm md:text-lg text-gray-600 text-center max-w-4xl mx-auto mb-8 md:mb-16">
            An exclusive, invite-only platform that connects verified investors
            with premium private investment opportunities. Our compliance-first
            approach ensures all deals are thoroughly vetted and NDA-protected.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 relative">
            ...
            <div className="flex flex-col items-center text-center group">
              ...
              <p className="text-sm text-gray-500 max-w-xs">
                Explore vetted, high-quality investment opportunities across
            ...
            <div className="flex flex-col items-center text-center group">
              ...
              <p className="text-sm text-gray-500 max-w-xs">
                Sign confidentiality agreements to unlock comprehensive deal
            ...
            <div className="flex flex-col items-center text-center group">
              ...
              <p className="text-sm text-gray-500 max-w-xs">
                Connect with deal sponsors and complete your investment through
                our secure platform.
              </p>
            </div>
          </div>
      ...
      <div className="bg-gray-100">
        ...
        <section className="container mx-auto py-10 md:py-20  px-4">
          <div className="flex flex-row items-center justify-between mb-8 gap-4">
            ...
            <Link
              href="/deals"
              className="text-purple-600 hover:text-purple-700 flex items-center gap-2 font-semibold group"
            >
              View All
              <svg
          ...
          {loading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[...Array(4)].map((_, idx) => (
                <div
                  key={idx}
                  className="bg-white rounded-xl shadow-sm border border-gray-100 flex flex-col relative animate-pulse"
                >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 relative">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-500 max-w-xs">
                Complete our verification process to access exclusive
                opportunities
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-500 max-w-xs">
                Secure confidential access to detailed deal information
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-500 max-w-xs">
                Explore opportunities and express your investment interest
              </p>
            </div>
          </div>
          ...
          <div className="mt-12">
            <Link
              ...
              rel="noopener noreferrer"
            >
              <Button variant="primary" className="text-lg px-8 mx-auto">
                Start Your Journey
              </Button>
            </Link>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {publicData.latest_blogs.slice(0, 4).map((blog, idx) => (
                <Card
                  ...
                  imageUrl={
                    blog.featured_image && blog.featured_image.path
                      ? `http://localhost:4000/${blog.featured_image.path.replace(
                          /\\/g,
                          "/"
                        )}`
                      : "/next.svg"
  ...
  function InvestorCarousel({ testimonials, loading }) {
    ...
    // Show 3 per row on large screens
      ...
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[...Array(2)].map((_, idx) => (
            <div
              key={idx}
              className="bg-gray-100 rounded-2xl p-6 md:p-8 animate-pulse"
            >
                ...
                {getVisibleTestimonials().map((testimonial, idx) => (
                  ...
                  >
                    ...
                    testimonial.testimonial_video ? (
                      <video
                        src={`http://localhost:4000/${(typeof testimonial.testimonial_video ===
                        "string"
                          ? testimonial.testimonial_video
                          : testimonial.testimonial_video.path
                        ).replace(/\\/g, "/")}`}
                        controls
                        className="rounded-lg w-full h-48 object-cover bg-black mb-2"
