...
export default function WhatsAppButton() {
  const handleWhatsAppClick = () => {
    ...
    const phoneNumber = "+919182173097"; // Replace with your actual WhatsApp number
    const message = "Hi! I'm interested in learning more about EquiGini investment opportunities.";
