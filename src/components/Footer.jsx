          ...
          <div className="col-span-1">
            ...
            <form onSubmit={handleSubscribe} className="relative">
              <input
                ...
                className="w-full px-4 py-3 bg-gray-900 text-white rounded-lg pr-12 focus:outline-none focus:ring-2 focus:ring-purple-600"
              />
              <Button
                variant="primary" 
                type="submit"
                className="absolute right-2 top-1/2 -translate-y-1/2 text-2xl bg-purple text-purple-600 hover:text-purple-500 transition-colors"
              >
                →
              </Button>
            </form>
